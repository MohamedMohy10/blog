...
1. The tips described above are not meant to replace prompt engineering and do not change the fact that you should learn prompt engineering yourself .. these are just extra tools to use and also sharpen your prompting.
...
3. The models mentioned here are not a requirment .. I have mentioned Claude and ChatGPT just for demonstration, but you can — and actually are encouraged to — use whichever models you're comfortable with and whichever ones you find suitable for your task.
